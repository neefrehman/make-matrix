...
// Test arrays of dimension-count `n`, with any initialised values of a boolean
test("1D test - With boolean initialValues", () => {
    expect(makeMatrix(1, true)).toStrictEqual([true]);
});

test("2D test - With boolean initialValues", () => {
    expect(makeMatrix(2, true)).toStrictEqual([[true], [true]]);
});

test("3D test - With boolean initialValues", () => {
    expect(makeMatrix(3, true)).toStrictEqual([
        [[true], [true]],
        [[true], [true]],
        [[true], [true]]
    ]);
...
test("4D test - With boolean initialValues", () => {
    expect(makeMatrix(4, true)).toStrictEqual([
        [
            [[true], [true]],
            [[true], [true]],
            [[true], [true]]
...
test("5D test - With boolean initialValues", () => {
    expect(makeMatrix(5, true)).toStrictEqual([
        [
            [
                [[true], [true]],
                [[true], [true]],
...
test("6D test - With boolean initialValues", () => {
    expect(makeMatrix(6, true)).toStrictEqual([
        [
            [
                [
                    [[true], [true]],
