...
// Test arrays of specific dimensions, with boolean initialised values
test("length: 1 test - With boolean initialValues", () => {
    expect(makeMatrix([1], false)).toStrictEqual([false]);
});

test("length: 2 test - With boolean initialValues", () => {
    expect(makeMatrix([2], false)).toStrictEqual([false, false]);
});

test("length: 7 test - With boolean initialValues", () => {
    expect(makeMatrix([7], false)).toStrictEqual([
        false,
        false,
        false,
        false,
...
test("1x1 test - With boolean initialValues", () => {
    expect(makeMatrix([1, 1], false)).toStrictEqual([[false]]);
});

test("1x4 test - With boolean initialValues", () => {
    expect(makeMatrix([2, 4], false)).toStrictEqual([
        [false, false, false, false],
        [false, false, false, false]
    ]);
});

test("4x11 test - With boolean initialValues", () => {
    expect(makeMatrix([4, 11], false)).toStrictEqual([
        [
            false,
            false,
            false,
...
test("1x1x1 test - With boolean initialValues", () => {
    expect(makeMatrix([1, 1, 1], false)).toStrictEqual([[[false]]]);
});

test("3x3x3 test - With boolean initialValues", () => {
    expect(makeMatrix([3, 2, 3], false)).toStrictEqual([
        [
            [false, false, false],
            [false, false, false]
        ],
...
test("1x1x1x1 test - With boolean initialValues", () => {
    expect(makeMatrix([1, 1, 1, 1], false)).toStrictEqual([[[[false]]]]);
});

test("1x4x5x2 test - With boolean initialValues", () => {
    expect(makeMatrix([1, 4, 5, 2], false)).toStrictEqual([
        [
            [
                [false, false],
                [false, false],
...
test("1x1x1x1x1 test - With boolean initialValues", () => {
...
test("1x1x1x1x1x1 test - With boolean initialValues", () => {
    expect(makeMatrix([1, 1, 1, 1, 1, 1], false)).toStrictEqual([
        [[[[[false]]]]]
    ]);
});

test("2x4x1x5x3x1 test - With boolean initialValues", () => {
    expect(makeMatrix([2, 4, 1, 5, 5, 1], false)).toStrictEqual([
        [
            [
                [
